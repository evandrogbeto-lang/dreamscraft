  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-colors duration-300 ${
        scrolled || open
          ? "bg-background/95 border-b border-brand-branco/15 backdrop-blur-md"
    ...
    >
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-6 lg:h-[4.25rem]">
        <Link
          to="/"
          aria-label="Dreamscraft Code — Home"
          className="group flex items-center rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-rosa focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
        ...
        <div className="hidden lg:block">
          <Link
            to="/estimar"
            className="inline-flex min-h-11 items-center rounded-lg bg-brand-branco px-4 py-2.5 text-sm font-medium tracking-tight text-brand-roxo transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-rosa focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
        ...
        <button
          type="button"
          onClick={toggle}
          className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-md p-2 text-brand-branco transition-colors hover:bg-brand-branco/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-rosa focus-visible:ring-offset-2 focus-visible:ring-offset-background lg:hidden"
            ...
            >
              ...
              >
                ...
                <Link
                  to="/estimar"
                  onClick={close}
                  className="mt-3 inline-flex min-h-11 items-center justify-center rounded-lg bg-brand-branco px-4 py-2.5 text-sm font-medium text-brand-roxo focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-rosa focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                  Solicitar diagnóstico
                </Link>
              </nav>
